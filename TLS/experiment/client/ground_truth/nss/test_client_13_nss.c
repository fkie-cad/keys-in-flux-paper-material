...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (n > 0) {
            ...
            // Treat internal error / fatal alert / key update related issues as expected
            if (strstr(err_str, "internal error") != NULL ||
                strstr(err_str, "fatal alert") != NULL ||
                strstr(err_str, "key update") != NULL ||
